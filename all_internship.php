...
<div class="container mt-5">
    ...
    <h2 class="headline">ALL INTERNSHIPS</h2>
    <div class="row">
        <?php
        while ($row = $stmt->fetch()) {
            ...
            echo '<img src="admin/intern/' . htmlspecialchars($row['display_image']) . '" class="card-img-top" alt="Internship Image" style="    height: 150px;
    object-fit: contain">';
            ...
            echo '<button style="Text=decoration:none;border:none; color:black; font-size:10px" class="read-more-btn" data-id="' . $row['id'] . '">...Read More</button>';
            echo '</p>';
