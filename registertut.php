...
$internship = $pdo->prepare("SELECT * FROM tuitions WHERE id = ?");
$internship->execute([$internshipId]);
$internship = $internship->fetch();

if (!$internship) {
    echo "Tuitions not found!";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['register'])) {
    ...
    if (move_uploaded_file($_FILES['screenshot']['tmp_name'], $screenshotPath)) {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO tuition_registrations (
                tuition_id, student_name, phone_number, email, 
...
<body>
    <div class="container">
        <div class="card card-style">
            ...
            <form action="registertut.php?id=<?php echo $internshipId; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="payment-details">
                    ...
                    <div class="column text-center">
                    <img src="<?php echo htmlspecialchars('admin/tut/' . $internship['qr_code_image']); ?>" class="img-fluid" alt="QR Code">
                    </div>
                    <br>
                ...
                <div class="column text-center"><br><br>
                    <button class="btn" type="submit" name="register"> <span style="color:white"> <i
